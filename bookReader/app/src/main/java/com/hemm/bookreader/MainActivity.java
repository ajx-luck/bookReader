...
import com.hemm.bookreader.ui.read.ReadActivity;
import com.hemm.bookreader.utils.EncodeUtils;
import com.hemm.bookreader.utils.Utils;
...
public class MainActivity extends BaseActivity {
    ...
    public void goRead(View view){
        ReadActivity.start(this,"http://www.17k.com/chapter/2065918/25913029.html");
     /*   try {
           String str = new String("第一章 沙漠中的彼岸花".getBytes("GBK"),"UTF-8");
           String str2 = EncodeUtils.toISO_8859_1(str);
           String str3 = EncodeUtils.toUTF_8(str2);
            mTitle.setText(str+"\n"+str2+"\n"+str3);
        } catch (IOException e) {
            e.printStackTrace();
        }*/
...
//    String content = "http://www.zwdu.com/book/23488/7078765.html";
}
